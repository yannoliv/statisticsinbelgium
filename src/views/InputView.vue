...
<main>
    <div class="overflow-hidden bg-gray-50 py-16 px-4 sm:px-6 lg:px-8 lg:py-24">
    <div class="relative mx-auto max-w-xl">
      ...
      <div class="text-center">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Fill in your Wage 😄</h2>
        <p class="mt-4 text-lg leading-6 text-gray-500">
            Help us expand our data so more people can enjoy the comparing and be even more confident of our data. Of course completely <b>anonymous</b>.
        </p>
      </div>
      <div class="mt-12">
